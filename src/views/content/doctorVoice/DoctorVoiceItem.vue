  ...
  <section class="no-img-article-item-section">
    <el-card class="no-img-article-card-box">
      ...
      <el-form :model="noImgArticleData" class="no-img-article-form" ref="noImgArticleForm" :rules="noImgArticleRules">
        <el-form-item label="文章圖示" prop="type">
          <el-select v-model="noImgArticleData.type" placeholder="Select" style="width: 240px">
            <el-option :key="0" label="生命之樹" value="生命之樹" />
            <el-option :key="1" label="心跳線" value="心跳線" />
            <el-option :key="2" label="拼圖塊" value="拼圖塊" />
          </el-select>
        </el-form-item>
